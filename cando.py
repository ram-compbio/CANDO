...
class Compound(object):
    def __init__(self, name, id_, index):
        ...
        self.sig = []
        ## @var aux_sig
        #   potentially temporary signature for things like pathways, 
        #   where "c.sig" needs to be preserved
        self.aux_sig = []
        ## @var indications
        #   this is every indication it is associated with from the
        #   mapping file
...
class CANDO(object):
    ...
    def __init__(self, c_map, i_map, matrix='', compute_distance=False, save_rmsds='', read_rmsds='',
                 ...
                 similarity=False, dist_metric='rmsd', protein_set='', rm_zeros=False, 
                 rm_compounds='', adr_map='', protein_distance=False, ncpus=1,):
        ## @var c_map 
